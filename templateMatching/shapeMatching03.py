...
#    gray = cv2.medianBlur(gray,ksize)
    ...
    cv2.putText(tempCimg,"Template",(10,30),cv2.FONT_HERSHEY_SIMPLEX,1.0,255,2,cv2.LINE_AA)
    cv2.putText(cimg,result + " / differ = " + "{:.4f}".format(match),(10,30),cv2.FONT_HERSHEY_SIMPLEX,1.0,color,2,cv2.LINE_AA)
    

    concat1 = cv2.vconcat([gray,binary])
    concat1 = cv2.cvtColor(concat1,cv2.COLOR_GRAY2RGB)

    cv2.putText(concat1,"image",(10,30),cv2.FONT_HERSHEY_SIMPLEX,1.0,(0,255,0),2,cv2.LINE_AA)
