...
while True:
    ...
    alpha = 1
    newKK, roiSize = cv2.getOptimalNewCameraMatrix(mtx, dist, imageSize, alpha, imageSize)
        
    mapX, mapY = cv2.initUndistortRectifyMap(mtx, dist, None, newKK, imageSize, cv2.CV_32FC1)
